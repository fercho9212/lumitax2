...
<div class="col-md-12">
  <div id="gallery-images">
      <ul>
          ...
          <li>
              <a href="{{url('photos/drivers/'.$driver->dri_cc.'/documents/'.$image->img_name)}}" target="_blank" data-lightbox="roadtrip">
                <img src="{{url('photos/drivers/'.$driver->dri_cc.'/documents/'.$image->img_name)}}" alt="">
              </a>
              <br>
